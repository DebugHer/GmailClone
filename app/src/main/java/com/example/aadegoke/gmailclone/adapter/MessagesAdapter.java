package com.example.aadegoke.gmailclone.adapter;
...
import com.example.aadegoke.gmailclone.helper.FlipAnimator;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    ...
    private void applyProfilePicture(MyViewHolder holder, Message message) {
        if (!TextUtils.isEmpty(message.getPicture())) {
            Picasso.get().load(message.getPicture()).into(holder.imgProfile);
